...
# DB with 5, 10 samples
./gdrive files download 1_RGX3_xML0nET5rGUiBN8F9larKwcjI3 # CUB_200_db_5
./gdrive files download 1izgVhCneOvobphz84yF_NbkO6XOAuu0H # CUB_200_db_10
tar -xf CUB_200_db_5.tar -C CUB_200
tar -xf CUB_200_db_10.tar -C CUB_200
rm CUB_200_db_5.tar
rm CUB_200_db_10.tar