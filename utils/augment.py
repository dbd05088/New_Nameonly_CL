...
def get_statistics(dataset: str, type_name:str):
    ...
    mean = {
        "cifar10": {
                    "cifar10_c":(0.4914, 0.4822, 0.4465),
                    "cifar10_nc":(0.52942301, 0.514956, 0.46244773),
    ...
    std = {
        "cifar10": {
                    "cifar10_c":(0.22923981, 0.23307575, 0.26722828),
                    "cifar10_nc":(0.22417389, 0.21921037, 0.22500719),
