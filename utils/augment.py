...
def get_statistics(dataset: str, type_name:str):
    ...
    mean = {
        ...
        "PACS_final": {
                    ...
                    "web_RMD_temp_2":(0.51474538, 0.48882951, 0.44258031),
                    "web_RMD_temp_3":(0.51947974, 0.49477125, 0.44861741),
                    "web_topk":(0.53115645, 0.50717552, 0.45721548),
                    "web_bottomk":(0.55778056, 0.53284965, 0.49349051),
                    "web_equalweight":(0.54111533, 0.51684937, 0.47208776),
                    "web_inverse_temp_2":(0.55804458, 0.53513301, 0.48987955),
                    "web_inverse_temp_3":(0.55719671, 0.53183584, 0.48582046),
                    },
        "OfficeHome": {
    ...
    std = {
        ...
        "PACS_final": {
                    ...
                    "web_RMD_temp_2":(0.23734616, 0.23187873, 0.237913),
                    "web_RMD_temp_3":(0.2379107,  0.23343094, 0.24031325),
                    "web_topk":(0.23675822, 0.23323846, 0.24302266),
                    "web_bottomk":(0.23663594, 0.23253554, 0.23881416),
                    "web_equalweight":(0.23480294, 0.23388333, 0.24232324),
                    "web_inverse_temp_2":(0.23902185, 0.23664334, 0.24358869),
                    "web_inverse_temp_3":(0.2395794,  0.237538,   0.24558495),
                    },
        "OfficeHome": {
