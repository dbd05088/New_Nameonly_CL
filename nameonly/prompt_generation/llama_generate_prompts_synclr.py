...
background_json_path = './prompts/backgrounds_synclr.json'; imagenet=False
prompt_json_path = './prompts/llama_synclr_PACS_50.json'
...
def sample_prompt(cls):
    ...
    response = ollama.generate(model='llama3', prompt=current_prompt)["response"]
