...
if [ "$DATASET" == "cifar10" ]; then
    ...
    BASEINIT_SAMPLES=6000 FEAT_DIM=7 FEAT_MEM_SIZE=1500
    ...
    MODEL_NAME="resnet18" VAL_PERIOD=500 EVAL_PERIOD=100
    BATCHSIZE=16; LR=3e-4 OPT_NAME="adam" SCHED_NAME="default" IMP_UPDATE_PERIOD=1
    BASEINIT_SAMPLES=1002 FEAT_DIM=7 FEAT_MEM_SIZE=300
    ...
    MODEL_NAME="resnet18" VAL_PERIOD=500 EVAL_PERIOD=100
    BATCHSIZE=16; LR=3e-4 OPT_NAME="adam" SCHED_NAME="default" IMP_UPDATE_PERIOD=1
    BASEINIT_SAMPLES=2614 FEAT_DIM=7 FEAT_MEM_SIZE=600
    SAMPLES_PER_TASK=2000
    if [ "$SEEDS" == "1" ]; then
    ...
    BASEINIT_SAMPLES=30523 FEAT_DIM=7 FEAT_MEM_SIZE=10500
    SAMPLES_PER_TASK=2000
    if [ "$SEEDS" == "1" ]; then
