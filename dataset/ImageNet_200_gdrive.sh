...
## tar -xf ImageNet_c.tar -C ImageNet_200
# tar -xf ImageNet_r_50.tar -C ImageNet_200
# tar -xf ImageNet_test.tar -C ImageNet_200
# tar -xf ImageNet_c_all.tar -C ImageNet_200
# tar -xf ImageNet_d_new.tar -C ImageNet_200
## rm ImageNet_c.tar
...
# tar -xf ImageNet_50_2_sdxl_floyd_cogview2_sd3_auraflow.tar -C ImageNet_200
...
# tar -xf ImageNet_50_2_sdxl.tar -C ImageNet_200
